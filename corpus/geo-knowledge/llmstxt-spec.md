...
source: geo-knowledge（非官方）
---
# llmstxt-spec.md

> 来源：https://llmstxt.org/
> 类型：GEO 生态规范（非官方）

The /llms.txt file, v2 – llms-txt
...
- [The /llms.txt file, v2](./index.html)
...
- [Report an issue](https://github.com/AnswerDotAI/llms-txt/issues/new)
...
[](#cb2-1)# Title
[](#cb2-2)
[](#cb2-3)&gt; Optional description goes here
[](#cb2-4)
[](#cb2-5)Optional details go here
[](#cb2-6)
[](#cb2-7)## Section name
[](#cb2-8)
[](#cb2-9)- [Link title](https://link_url): Optional link details
[](#cb2-10)
[](#cb2-11)## Optional
[](#cb2-12)
[](#cb2-13)- [Link title](https://link_url)
...
[](#cb3-1)# FastHTML
[](#cb3-2)
[](#cb3-3)&gt; FastHTML is a python library which brings together Starlette, Uvicorn, HTMX, and fastcore's `FT` "FastTags" into a library for creating server-rendered hypermedia applications.
[](#cb3-4)
[](#cb3-5)Important notes:
[](#cb3-6)
[](#cb3-7)- Although parts of its API are inspired by FastAPI, it is *not* compatible with FastAPI syntax and is not targeted at creating API services
[](#cb3-8)- FastHTML is compatible with JS-native web components and any vanilla JS library, but not with React, Vue, or Svelte.
[](#cb3-9)
[](#cb3-10)## Docs
[](#cb3-11)
[](#cb3-12)- [FastHTML quick start](https://fastht.ml/docs/tutorials/quickstart_for_web_devs.html.md): A brief overview of many FastHTML features
[](#cb3-13)- [HTMX reference](https://github.com/bigskysoftware/htmx/blob/master/www/content/reference.md): Brief description of all HTMX attributes, CSS classes, headers, events, extensions, js lib methods, and config options
[](#cb3-14)
[](#cb3-15)## Examples
[](#cb3-16)
[](#cb3-17)- [Todo list application](https://github.com/AnswerDotAI/fasthtml/blob/main/examples/adv_app.py): Detailed walk-thru of a complete CRUD app in FastHTML showing idiomatic use of FastHTML and HTMX patterns.
[](#cb3-18)
[](#cb3-19)## Optional
[](#cb3-20)
[](#cb3-21)- [Starlette full documentation](https://gist.githubusercontent.com/jph00/809e4a4808d4510be0e3dc9565e9cbd3/raw/9b717589ca44cedc8aaf00b2b8cacef922964c0f/starlette-sml.md): A subset of the Starlette documentation useful for FastHTML development. 
